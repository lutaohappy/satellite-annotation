...
| 版本 | 日期 | 说明 |
|------|------|------|
| v3.0 (20260421-48-路段数据持久化) | 2026-04-22 | 后端添加 roadSegments 字段存储路段数据，修复历史记录查看时路段详情不显示问题 |
| v3.0 (20260421-47-路段表格优化) | 2026-04-22 | 优化路段详情表格显示：路段名称、起止坐标、转弯半径&角度、通过属性、导航属性、路长 |
| v3.0 (20260421-44-查看历史启用) | 2026-04-21 | 启用查看历史按钮，无数据时显示空状态提示 |
